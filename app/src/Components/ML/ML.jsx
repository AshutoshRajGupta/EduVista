        ...
        <div className="maindiv_content" id="yash_div">
              ...
              <div className="all_links">
                ...
                >
                  ...
                  <div className="site1">
                    <p align="justify">
                      <a
                        href="https://colab.research.google.com/notebooks/welcome.ipynb#scrollTo=xitplqMNk_Hc"
                        target="_blank"
                      >
                        Google Colab
                      </a>
          ...
          <div className="Projects">
            ...
            <div className="suggest_con">
              ...
              <div className="texts">
                {/* <p>Suggestion</p> */}
                <a href="https://docs.google.com/document/d/1yIXDV4XPtNHDwp9Dg1BShz2aQIS1xN3Qt32hS0LZpw4/edit?usp=sharing" target="_blank"> Project Ideas</a>
              </div>
            </div>
          </div>
          <div className="Roadmap">
            ...
            <div className="roadmap_con">
              ...
              <div className="button">
                <a
                  href="https://www.codelivly.com/machine-learning-roadmap/"
                  target="_blank"
                >
                  Get the road map
                </a>
            ...
            <div className="course_marquee">
              ...
              >
                ...
                <SwiperSlide>
                  {" "}
                  <a
                    href="https://in.coursera.org/learn/machine-learning"
                    target="blank"
                  >
                    <img className="im1" src={crs2} />
                  </a>
                ...
                <SwiperSlide>
                  {" "}
                  <a
                    href="https://www.udemy.com/course/data-science-and-machine-learning-with-python-hands-on/"
                    target="blank"
                  >
                    <img className="im1" src={crs4} />
                  </a>
