        ...
        <div className="maindiv_content" id="yash_div">
          ...
          <div className="Projects">
            ...
            <div className="suggest_con">
              ...
              <div className="texts">
                {/* <p>Suggestion</p> */}
                <a href="https://docs.google.com/document/d/1-ur7bJdxScU72AME_4okAcNdhKZ4e-DMU_R5HEnlpEk/edit?usp=sharing" target="_blank"> Project Ideas</a>
              </div>
            </div>
          </div>
          <div className="Roadmap">
            ...
            <div className="roadmap_con">
              ...
              <div className="button">
                <a
                  href="https://www.geeksforgeeks.org/complete-roadmap-to-learn-dsa-from-scratch/"
                  target="blank"
                >
                  Get the road map
                </a>
