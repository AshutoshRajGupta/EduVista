        ...
        <div className="maindiv_content" id="yash_div">
              ...
              <div className="all_links">
                ...
                >
                  ...
                  <div className="site1">
                    <p align="justify">
                      <a
                        href="https://www.figma.com/graphic-design-tool/"
                        target="_blank"
                      >
                        Figma
                      </a>
          ...
          <div className="Projects">
            ...
            <div className="suggest_con">
              ...
              <div className="texts">
                {/* <p>Suggestion</p> */}
                <a href="https://docs.google.com/document/d/1SslAyFLtEdqhmPbWUMrxdOzxbzA2sZclJBpOar6g72Y/edit?usp=sharing" target="_blank"> Project Ideas</a>
              </div>
            </div>
          </div>
          <div className="Roadmap">
            ...
            <div className="roadmap_con">
              ...
              <div className="button">
                <a
                  href="https://www.youtube.com/watch?v=vkSOIkNWCww"
                  target="_blank"
                >
                  Get the road map
                </a>
            ...
            <div className="course_marquee">
              ...
              >
                ...
                <SwiperSlide>
                  {" "}
                  <a
                    href="https://in.coursera.org/specializations/graphic-design"
                    target="blank"
                  >
                    <img className="im1" src={crs2} />
                  </a>
                ...
                <SwiperSlide>
                  {" "}
                  <a
                    href="https://www.udemy.com/course/graphic-design-for-beginners/"
                    target="blank"
                  >
                    <img className="im1" src={crs4} />
                  </a>
