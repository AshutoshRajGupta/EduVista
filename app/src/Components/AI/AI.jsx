        ...
        <div className="maindiv_content" id="yash_div">
              ...
              <div className="all_links">
                ...
                >
                  ...
                  <div className="site1">
                    <p align="justify">
                      <a
                        href="https://research.ibm.com/artificial-intelligence"
                        target="_blank"
                      >
          ...
          <div className="Projects">
            ...
            <div className="suggest_con">
              ...
              <div className="texts">
                {/* <p>Suggestion</p> */}
                <a href="https://docs.google.com/document/d/1Ozg0JoCWqBfu3153784OU_5TsbS2WvZEtO2Udi7--j8/edit?usp=sharing" target="_blank"> Project Ideas</a>
              </div>
            </div>
          </div>
          <div className="Roadmap">
            ...
            <div className="roadmap_con">
              ...
              <div className="button">
                <a
                  href="https://www.youtube.com/watch?v=I6BRHxNilMw"
                  target="_blank"
                >
                  Get the road map
                </a>
            ...
            <div className="course_marquee">
              ...
              >
                ...
                <SwiperSlide>
                  {" "}
                  <a
                    href="https://in.coursera.org/learn/ai-for-everyone"
                    target="blank"
                  >
                    <img className="im1" src={crs2} />
                  </a>
