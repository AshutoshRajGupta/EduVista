        ...
        <div className="maindiv_content" id="yash_div">
              ...
              <div className="all_links">
                ...
                >
                  ...
                  <div className="site1">
                    <p align="justify">
                      <a
                        href="https://cybercademy.org/training-platforms/"
                        target="_blank"
                      >
                        CyberCademy
                      </a>
          ...
          <div className="Projects">
            ...
            <div className="suggest_con">
              ...
              <div className="texts">
                {/* <p>Suggestion</p> */}
                <a href="https://docs.google.com/document/d/13jZPJh8hWN9x_g4PygioVEzFbFVQsG1EbsO3UJKGgNQ/edit?usp=sharing" target="_blank"> Project Ideas</a>
              </div>
            </div>
          </div>
          <div className="Roadmap">
            ...
            <div className="roadmap_con">
              ...
              <div className="button">
                <a
                  href="https://www.youtube.com/watch?v=nL2vHJ53Wr4"
                  target="_blank"
                >
                  Get the road map
                </a>
            ...
            <div className="course_marquee">
              ...
              >
                ...
                <SwiperSlide>
                  {" "}
                  <a
                    href="https://www.udemy.com/course/the-complete-internet-security-privacy-course-volume-1/"
                    target="blank"
                  >
                    <img className="im1" src={crs2} />
                  </a>
                ...
                <SwiperSlide>
                  {" "}
                  <a
                    href="https://intellipaat.com/cyber-security-course-certification/"
                    target="blank"
                  >
                    <img className="im1" src={crs4} />
                  </a>
